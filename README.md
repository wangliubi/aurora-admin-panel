...
```shell
bash <(curl -fsSL https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/install.sh)
# 国内机器安装可以选择使用 fastgit 镜像
# 但由于拉取 docker 镜像时候默认服务器仍在国外，可能拉取速度较慢
# 可自行搜索如何配置 Docker Hub 国内镜像加速
# bash <(curl -fsSL https://raw.fastgit.org/wangliubi/aurora-admin-panel/main/install.sh) --mirror
```
...
```shell
mkdir -p ~/aurora && cd ~/aurora && wget https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/docker-compose.yml -O docker-compose.yml && docker-compose up -d
...
```shell
cd ~/aurora
wget https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/docker-compose.yml -O docker-compose.yml
...
```shell
cd ~/aurora
wget https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/docker-compose-dev.yml -O docker-compose.yml
docker-compose pull && docker-compose down --remove-orphans && docker-compose up -d
```
...
![](https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/img/servers.png)

#### 修改/添加服务器

![](https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/img/servers_edit.png)

### 服务器端口管理页面

![](https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/img/server.png)

#### 添加/编辑端口

![](https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/img/server_port_edit.png)

#### 端口分配页面

![](https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/img/server_port_users.png)

#### 端口设置 iptables

![](https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/img/server_port_edit_rule_iptables.png)

#### 端口设置 gost

![](https://raw.githubusercontent.com/wangliubi/aurora-admin-panel/main/img/server_port_edit_rule_gost.png)
